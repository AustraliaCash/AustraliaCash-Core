### Building cyberdollar-qt 1.14 on modern macs. ###
...
### Clone cyberdollar locally, or check it out, etc. ###

For this purpose, just indicating the 1.14-branding branch in my repo.

	$git clone -b 1.14-branding --single-branch https://github.com/michilumin/cyberdollar.git
...
### Go back to your CyberDollar repo ###
