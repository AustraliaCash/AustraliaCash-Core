### Building australiacash-qt 1.14 on modern macs. ###
...
### Clone australiacash locally, or check it out, etc. ###

For this purpose, just indicating the 1.14-branding branch in my repo.

	$git clone -b 1.14-branding --single-branch https://github.com/michilumin/australiacash.git
...
### Go back to your AustraliaCash repo ###
...
Run it.
	...
	$/usr/local/bin/australiacash-qt
