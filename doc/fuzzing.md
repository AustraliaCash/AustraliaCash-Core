...
export AFL_HARDEN=1
cd src/
make test/test_australiacash_fuzzy
```
...
`test_australiacash_fuzzy` binary will be instrumented in such a way that the AFL
...
```
$AFLPATH/afl-fuzz -i ${AFLIN} -o ${AFLOUT} -m52 -- test/test_australiacash_fuzzy
```
