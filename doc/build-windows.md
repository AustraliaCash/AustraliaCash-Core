...
Note that for WSL v1 the AustraliaCash Core source path MUST be somewhere in the default mount file system, for
example /usr/src/australiacash, AND not under, for example, /mnt/d/australiacash. 
