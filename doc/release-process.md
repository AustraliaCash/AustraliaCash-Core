...
- Detached signatures will then be committed to the [australiacash-detached-sigs](https://github.com/acash/australiacash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the australiacash.org Github repo
...
- Update australiacash.org version - Langerhans to do

- Announce the release:

  - Release sticky on AustraliaCash Forums: http://forum.australiacash.org/forum/news-community/community-announcements
