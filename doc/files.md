...
* australiacash.conf: contains configuration settings for australiacashd or australiacash-qt
* australiacashd.pid: stores the process id of australiacashd while running
