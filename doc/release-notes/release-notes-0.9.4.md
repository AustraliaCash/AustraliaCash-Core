AustraliaCash Core version 0.9.4 is now available from:

  https://australiacash.org/bin/0.9.4/
...
this update is incompatible with the AustraliaCash system and could lead to consensus
forks.

AustraliaCash Core released binaries from https://australiacash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~australiacash/+archive/ubuntu/australiacash
- A third-party or self-compiled AustraliaCash Core

upgrade to AustraliaCash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
