AustraliaCash Core version 0.16.1 is now available from:

  <https://australiacashcore.org/bin/australiacash-core-0.16.1/>
...
- #12843 `df38b13` Test starting australiacashd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure australiacashd processes are cleaned up when tests end (sdaftuar)
