AustraliaCash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/australiacash/files/AustraliaCash/australiacash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the AustraliaCash
...
New/changed settings (command-line or australiacash.conf file)
--------------------------------------------------------
