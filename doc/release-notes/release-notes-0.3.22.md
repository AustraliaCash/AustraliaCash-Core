Download URL: https://sourceforge.net/projects/australiacash/files/AustraliaCash/australiacash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 AUS fee schedule (users still pay 0.01 AUS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #australiacash00 - #australiacash99
