AustraliaCash Core version *0.15.0.1* is now available from:

  <https://australiacash.org/bin/australiacash-core-0.15.0.1/>

and

  <https://australiacashcore.org/bin/australiacash-core-0.15.0.1/>
