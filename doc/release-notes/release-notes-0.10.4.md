AustraliaCash Core version 0.10.4 is now available from:

  <https://australiacash.org/bin/australiacash-core-0.10.4/>
...
- #6953 `43c2789` Split australiacash-tx into its own package
- #6953 `dfe0d4d` Include australiacash-tx binary on Debian/Ubuntu
