AustraliaCash Core version 0.13.2 is now available from:

  <https://australiacash.org/bin/australiacash-core-0.13.2/>
...
- #8908 `4a974b2` Update australiacash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow australiacash-tx to create v2 transactions (eacdrak)
