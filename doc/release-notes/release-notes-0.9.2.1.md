AustraliaCash Core version 0.9.2.1 is now available from:

  https://australiacash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AUS to 0.01 AUS
...
- Fix "Start australiacash on system login"
