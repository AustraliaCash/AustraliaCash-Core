...
/** Recommended transaction fee by AustraliaCash Core developers
  *
 ...
 *
 *  AustraliaCash:    Increment mempool limits and accept RBF in steps of 0.0001 AUS
...
/**
 * AustraliaCash: Default dust limit that is evaluated when considering whether a
...
/**
 * AustraliaCash: Default hard dust limit that is evaluated when considering whether
