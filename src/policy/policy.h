...
/** Recommended transaction fee by CyberDollar Core developers
  *
 ...
 *
 *  CyberDollar:    Increment mempool limits and accept RBF in steps of 0.0001 CYBER
...
/**
 * CyberDollar: Default dust limit that is evaluated when considering whether a
...
/**
 * CyberDollar: Default hard dust limit that is evaluated when considering whether
