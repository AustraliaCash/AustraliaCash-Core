...
// Copyright (c) 2009-2013 The AustraliaCash developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef AUSTRALIACASH_PRIMITIVES_PUREHEADER_H
#define AUSTRALIACASH_PRIMITIVES_PUREHEADER_H
...
#endif // AUSTRALIACASH_PRIMITIVES_PUREHEADER_H
