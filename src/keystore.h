...
#ifndef AUSTRALIACASH_KEYSTORE_H
#define AUSTRALIACASH_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/australiacash/bips/blob/master/bip-0013.mediawiki
...
#endif // AUSTRALIACASH_KEYSTORE_H
