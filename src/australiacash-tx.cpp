...
static void SetupAustraliaCashTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " australiacash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  australiacash-tx [options] <hex-tx> [commands]  Update hex-encoded australiacash transaction\n" +
            "or:     australiacash-tx [options] -create [commands]   Create hex-encoded australiacash transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded australiacash transaction
