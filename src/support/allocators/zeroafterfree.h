...
#ifndef AUSTRALIACASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define AUSTRALIACASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // AUSTRALIACASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
