...
#ifndef AUSTRALIACASH_INTERFACES_NODE_H
#define AUSTRALIACASH_INTERFACES_NODE_H
...
//! Top-level interface for a australiacash node (australiacashd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // AUSTRALIACASH_INTERFACES_NODE_H
