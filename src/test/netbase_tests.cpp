...
{
    BOOST_CHECK(TestSplitHost("www.australiacashcore.org", "www.australiacashcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.australiacashcore.org]", "www.australiacashcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.australiacashcore.org:80", "www.australiacashcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.australiacashcore.org]:80", "www.australiacashcore.org", 80));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11081", "127.0.0.1:11081"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11081", "[::]:11081"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
