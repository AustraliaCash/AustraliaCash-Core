...
/* 1.14.5: set the wallet's discard threshold to 1 CYBER because that's what 97%
 ...
 */
/* 1.14.6: set the wallet's discard threshold to 0.01 CYBER. Very network
...
/*
 * CyberDollar: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * CyberDollar: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * CyberDollar: Get a fee targetting a specific transaction speed.
     */
    CAmount GetCyberDollarPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * CyberDollar: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetCyberDollarPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the CyberDollar dust fee.
     */
