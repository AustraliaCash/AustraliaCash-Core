...
/* 1.14.5: set the wallet's discard threshold to 1 AUS because that's what 97%
 ...
 */
/* 1.14.6: set the wallet's discard threshold to 0.01 AUS. Very network
...
/*
 * AustraliaCash: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * AustraliaCash: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * AustraliaCash: Get a fee targetting a specific transaction speed.
     */
    CAmount GetAustraliaCashPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * AustraliaCash: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetAustraliaCashPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the AustraliaCash dust fee.
     */
