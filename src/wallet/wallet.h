...
#ifndef AUSTRALIACASH_WALLET_WALLET_H
#define AUSTRALIACASH_WALLET_WALLET_H
...
public:
     ...
     * on this australiacash node, and set to 0 for transactions that were created
...
#endif // AUSTRALIACASH_WALLET_WALLET_H
