...
#ifndef AUSTRALIACASH_QT_WALLETMODEL_H
#define AUSTRALIACASH_QT_WALLETMODEL_H
...
/** Interface to AustraliaCash wallet from Qt view code. */
...
#endif // AUSTRALIACASH_QT_WALLETMODEL_H
