    ...
    platformStyle(_platformStyle)
{
    ...
    // AustraliaCash: load fallback font in case Comic Sans is not available on the system
    ...
    // AustraliaCash: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // AustraliaCash: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    importPrivateKeyAction->setStatusTip(tr("Import a AustraliaCash private key"));
