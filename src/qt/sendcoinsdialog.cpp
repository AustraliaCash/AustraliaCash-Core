...
void SendCoinsDialog::updateFeeSectionControls()
{
    ...
    // AustraliaCash: We don't use smart fees in the UI, so don't need to warn they're not available
...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        // AustraliaCash: We manually set height well past the last hard fork here
        ui->confirmationTargetLabel->setText(GetAustraliaCashPriorityLabel(nPriority).c_str());
    }
    else
    {
...
void SendCoinsDialog::updateFeeLabel()
{
    ...
    int nPriority = ui->sliderSmartFee->value();
    CFeeRate feeRate = GetAustraliaCashFeeRate(nPriority);
    ...
    else
    {
        ...
        // AustraliaCash: We don't use smart fees, so we don't have the data to estimate when it will get in
        ui->labelFeeEstimation->setText("");
