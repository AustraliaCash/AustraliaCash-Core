...
#ifndef AUSTRALIACASH_QT_AUSTRALIACASHGUI_H
#define AUSTRALIACASH_QT_AUSTRALIACASHGUI_H
...
public:
    ...
    explicit AustraliaCashGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AustraliaCashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a australiacash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // AUSTRALIACASH_QT_AUSTRALIACASHGUI_H
