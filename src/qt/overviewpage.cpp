...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the CyberDollar Core repository on GitHub"),
        tr("Services that claim to double your cyberdollars are always ponzi schemes")
    };
