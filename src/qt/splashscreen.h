...
#ifndef AUSTRALIACASH_QT_SPLASHSCREEN_H
#define AUSTRALIACASH_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. AustraliaCash Core initialization
...
#endif // AUSTRALIACASH_QT_SPLASHSCREEN_H
