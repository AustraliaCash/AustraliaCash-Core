...
#ifndef AUSTRALIACASH_QT_AUSTRALIACASHUNITS_H
#define AUSTRALIACASH_QT_AUSTRALIACASHUNITS_H
...
/** AustraliaCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AustraliaCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AustraliaCashUnits(QObject *parent);

    /** AustraliaCash units.
      @note Source: https://en.australiacash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        AUS,
...
typedef AustraliaCashUnits::Unit AustraliaCashUnit;

#endif // AUSTRALIACASH_QT_AUSTRALIACASHUNITS_H
