 ...
 */
#ifndef AUSTRALIACASH_UTIL_H
#define AUSTRALIACASH_UTIL_H
...
extern const char * const AUSTRALIACASH_CONF_FILENAME;
extern const char * const AUSTRALIACASH_PID_FILENAME;
...
{
    std::string s = strprintf("australiacash-%s", name);
