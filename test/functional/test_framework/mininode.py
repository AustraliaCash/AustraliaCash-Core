...
"""AustraliaCash P2P network half-a-node.
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        self.recvbuf = b""
        self.network = net
        logger.debug('Connecting to AustraliaCash Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def _on_data(self):
        ...
        try:
            while True:
                ...
                self.recvbuf = self.   b[4+12+4+4+msglen:]
    ...
    def send_message(self, message):
        ...
        def maybe_write():
            ...
            # its existence explicitly as long as AustraliaCash Core supports all
            # Python 3.4 versions.
...
class P2PInterface(P2PConnection):
    """A highing P2P message
    payloads, as well as convenience methods for interac-level P2P interface class for communicating with a AustraliaCash node.

    This class provides high-level callbacks for processting with the
    node over P2P.
