...
class BIP66Test(AustraliaCashTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # australiacashd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and australiacashd produces more specific reject
            # reasons.
