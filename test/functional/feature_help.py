...
"""Verify that starting australiacash with -h works as expected."""

from test_framework.test_framework import AustraliaCashTestFramework
from test_framework.util import assert_equal

class HelpTest(AustraliaCashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start australiacash with -h for help text")
        ...
        self.log.info("Start australiacash with -version for version information")
        ...
        self.log.info("Start australiacashd with -fakearg to make sure it does not start")
