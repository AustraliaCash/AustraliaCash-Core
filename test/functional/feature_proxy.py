...
Test plan:
- Start australiacashd's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on australiacashd side:
...
- Create australiacashds that connect to them
- Manipulate the australiacashds using addnode (onetry) an observe effects
