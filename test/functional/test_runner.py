...
`test/functional/test_framework/test_framework.py:AustraliaCashTestFramework.main`.
...
BASE_SCRIPTS = [
    ...
    'interface_zmq.py',
    'interface_australiacash_cli.py',
...
def main():
    ...
    enable_australiacashd = config["components"].getboolean("ENABLE_AUSTRALIACASHD")

    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/australiacash/australiacash/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/australiacash/australiacash/pull/5677#issuecomment-136646964
        print("Tests currently disabled on Windows by default. Use --force option to enable")
        sys.exit(0)

    if not enable_australiacashd:
...
def run_tests(test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False):
    ...
    # Warn if australiacashd is already running (unix only)
    try:
