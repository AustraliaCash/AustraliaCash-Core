...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/cyberdollar.ico %{buildroot}%{_datadir}/pixmaps/cyberdollar.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/cyberdollar16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/cyberdollar32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/cyberdollar64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/cyberdollar128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/cyberdollar256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/cyberdollar256.png %{buildroot}%{_datadir}/pixmaps/cyberdollar16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/cyberdollar256.png %{buildroot}%{_datadir}/pixmaps/cyberdollar32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/cyberdollar256.png %{buildroot}%{_datadir}/pixmaps/cyberdollar64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/cyberdollar256.png %{buildroot}%{_datadir}/pixmaps/cyberdollar128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/cyberdollar256.png %{buildroot}%{_datadir}/pixmaps/cyberdollar256.xpm
